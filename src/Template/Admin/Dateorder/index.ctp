...
<script>
                ...
                $(function () {
                    ...
                    $("#list").jqGrid({
                        ...
                        mtype: "POST",
                        colNames:
                                ['男方', '女方', '对应约会', '用户技能', '订单状态', '约会地点', '总金额', '是否被投诉', '预约金', '预约金占比', '开始时间', '结束时间', '约会总时间', '支付预约金时间点', '是否已被阅读', '美女接单时间点', '生成时间', '订单更新时间', '操作'],
                        colModel: [
                            ...
                            {name: 'site', editable: false, align: 'center'},
                            ...
                            {name: 'is_read', editable: false, align: 'center'},
