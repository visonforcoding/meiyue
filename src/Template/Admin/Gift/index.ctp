    ...
    <div class="col-xs-12">
        <form id="table-bar-form">
            <div class="table-bar form-inline">
                <a href="/gift/add" class="btn btn-small btn-warning">
...
<?php $this->start('script'); ?>
    ...
    <script>
        $(function () {
            ...
            $("#list").jqGrid({
                ...
                colModel: [
                    ...
                    {name:'pic',editable:true,align:'center', formatter: function(cellvalue, options, rowObject) {
                        response = "<img height='50px' width='50px' src='" +　cellvalue　+　"' />";
                        return response;
                    }},
        ...
        function actionFormatter(cellvalue, options, rowObject) {
            ...
            response += '<a title="编辑" href="/gift/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
            return response;
        }
