...
<?php $this->end()  ?> 
<div class="work-copy">
    <?= $this->Form->create($log, ['class' => 'form-horizontal']) ?>
        <div class="form-group">
        <label class="col-md-2 control-label">flag</label>
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('flag', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">msg</label>
        <div class="col-md-8">
                        <?php
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('data', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
