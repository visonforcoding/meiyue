...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/log/add" class="btn btn-small btn-warning">
...
<script>
                ...
                $(function () {
                    ...
                    $("#list").jqGrid({
                        ...
                        mtype: "POST",
                        colNames:
                                ['flag', 'msg', 'create_time', '操作'],
                        colModel: [
                            {name: 'flag', editable: false, align: 'center'},
                            {name: 'msg', editable: false, align: 'center'},
                ...
                function actionFormatter(cellvalue, options, rowObject) {
                    ...
                    response += '<a title="编辑" href="/log/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
                    return response;
                }
                ...
                function doExport() {
                    ...
                    $("body").append("<iframe src='/log/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
                function saveEdit() {
                    $('#list').jqGrid('saveRow', lastsel, {
                        successfunc: function (res) {
