    ...
    <div class="col-xs-12">
        <form id="table-bar-form">
            <div class="table-bar form-inline">
                <a href="/ptmsg/add" class="btn btn-small btn-warning">
                    <i class="icon icon-plus-sign"></i> 新消息
                </a>
                &nbsp;
                <div class="form-group">
                    <label for="keywords">发布时间</label>
...
<?php $this->start('script'); ?>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#list").jqGrid({
                url: "/ptmsg/getDataList",
                datatype: "json",
                mtype: "POST",
                colNames: ['发送主题', '发送对象', '创建时间', '操作'],
                colModel: [
                    {name: 'title', editable: true, align: 'center'},
                    {name: 'towho', editable: true, align: 'center', formatter: function(cellvalue, options, rowObject){
                        return towhos[cellvalue];
                    }},
