...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/skills/add" class="btn btn-small btn-warning">
...
{name:'actionBtn',align:'center',viewable:false,sortable:false,frozen:true,formatter:actionFormatter}],
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a title="编辑" href="/skills/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.store.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/skills/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
