...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/tags/add" class="btn btn-small btn-warning">
...
<script>
    $(function () {
       ...
       $(document).keypress(function (e) {
        ...
        $("#list").jqGrid({
             ...
             {name:'parent_id',editable:true,align:'center'},
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a title="编辑" href="/tags/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.store.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/tags/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
