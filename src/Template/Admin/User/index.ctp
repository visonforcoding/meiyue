    ...
    <script>
        $(function () {
            ...
            $("#list").jqGrid({
                ...
                datatype: "json",
                mtype: "POST",
                colNames: ['编号', '手机号', '昵称', '真实姓名', '性别', '常驻城市', '头像', '账户余额', '审核', '账号状态 ：1.可用0禁用(控制登录)', '是否假删除：1,是0否', '注册设备', '创建时间', '修改时间', '唯一码（用于扫码登录）', '操作'],
                colModel: [
                    ...
                    {name: 'gender', editable: true, align: 'center'},
                    {name: 'city', editable: true, align: 'center'},
                    {name: 'avatar', editable: true, align: 'center'},
                    {name: 'money', editable: true, align: 'center'},
                    {name: 'status', editable: true, align: 'center'},
                    {name: 'enabled', editable: true, align: 'center'},
                    {name: 'is_del', editable: true, align: 'center'},
                    {name: 'device', editable: true, align: 'center'},
                    {name: 'create_time', editable: true, align: 'center'},
                    {name: 'update_time', editable: true, align: 'center'},
                    {name: 'guid', editable: true, align: 'center'},
                    {
                        name: 'actionBtn',
                        align: 'center',
                        viewable: false,
