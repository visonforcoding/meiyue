...
<?php $this->end() ?>
    <div class="work-copy">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo $this->Form->input('skill_id', ['label' => false, 'options' => $skills, 'class' => 'form-control']); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php
                echo $this->Form->input('is_used', ['label' => false, 'type' => 'select', "options" => [1 => "是", 0 => "否"], 'class' => 'form-control']);
                ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php
                echo $this->Form->input('is_checked', ['label' => false, 'type' => 'select', "options" => \App\Model\Table\UserSkillsTable::getCheckStatus(), 'class' => 'form-control']);
                ?>
            </div>
        </div>
        <div class="form-group">
