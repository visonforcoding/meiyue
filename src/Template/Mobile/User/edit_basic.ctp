        ...
        <div class="home_fill_basic_info">
            ...
            <ul>
                ...
                <li>
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname">真</span><span
                                    ...
                                    class="itemsname">名</span><?php if ($user->gender == 2): ?><i
                                    class="iconfont ico"></i><?php endif; ?></div>
                        <div class="home_list_r_info">
                ...
                <li class="birthdate right-ico">
                    <div class="home_items">
                        <div class="home_list_l_info required">
                            <span class="itemsname">出</span><span class="itemsname">生</span><span
                                    class="itemsname">日</span><span class="itemsname">期</span>
                        ...
                        <div class="home_list_r_info">
                            <div class="home-basic-option">
                                <input id="birthday" name="birthday" type="text" placeholder="出生日期" readonly="readonly"
                                       value="<?= ($user->birthday) ? $user->birthday : new Date('1991-1-1'); ?>"
                                       required='required'/>
                ...
                <li class="right-ico">
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname">体</span><span
                                    class="itemsname">重</span>
                            <?php if ($user->gender == 2): ?><i class="iconfont ico"></i><?php endif; ?>
                        </div>
                        <div class="home_list_r_info">
                            <div class="home-basic-option">
                                <input type="text" placeholder="你的体重" readonly="readonly"
                                       value="<?= isset($user->weight) ? $user->weight : '40-'; ?>KG"/>
                                <select id="weight" name="weight" onchange='tochange(this)'>
                                    <option value="40-" <?= (isset($user->weight) && $user->weight == '40-') ? 'selected' : ''; ?>>
                                        40-KG
                                    </option>
                                    <option value="40" <?= (isset($user->weight) && $user->weight == '40') ? 'selected' : ''; ?>>
                                        40KG
                                    </option>
                                    <option value="41" <?= (isset($user->weight) && $user->weight == '41') ? 'selected' : ''; ?>>
                                        41KG
                                    </option>
                                    <option value="42" <?= (isset($user->weight) && $user->weight == '42') ? 'selected' : ''; ?>>
                                        42KG
                                    </option>
                                    <option value="43" <?= (isset($user->weight) && $user->weight == '43') ? 'selected' : ''; ?>>
                                        43KG
                                    </option>
                                    <option value="44" <?= (isset($user->weight) && $user->weight == '44') ? 'selected' : ''; ?>>
                                        44KG
                                    </option>
                                    <option value="45" <?= (isset($user->weight) && $user->weight == '45') ? 'selected' : ''; ?>>
                                        45KG
                                    </option>
                                    <option value="46" <?= (isset($user->weight) && $user->weight == '46') ? 'selected' : ''; ?>>
                                        46KG
                                    </option>
                                    <option value="47" <?= (isset($user->weight) && $user->weight == '47') ? 'selected' : ''; ?>>
                                        47KG
                                    </option>
                                    <option value="48" <?= (isset($user->weight) && $user->weight == '48') ? 'selected' : ''; ?>>
                                        48KG
                                    </option>
                                    <option value="49" <?= (isset($user->weight) && $user->weight == '49') ? 'selected' : ''; ?>>
                                        49KG
                                    </option>
                                    <option value="50" <?= (isset($user->weight) && $user->weight == '50') ? 'selected' : ''; ?>>
                                        50KG
                                    </option>
                                    <option value="51" <?= (isset($user->weight) && $user->weight == '51') ? 'selected' : ''; ?>>
                                        51KG
                                    </option>
                                    <option value="52" <?= (isset($user->weight) && $user->weight == '52') ? 'selected' : ''; ?>>
                                        52KG
                                    </option>
                                    <option value="53" <?= (isset($user->weight) && $user->weight == '53') ? 'selected' : ''; ?>>
                                        53KG
                                    </option>
                                    <option value="54" <?= (isset($user->weight) && $user->weight == '54') ? 'selected' : ''; ?>>
                                        54KG
                                    </option>
                ...
                <li class="right-ico">
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname short_name">身</span><span
                                    class="itemsname">高</span><?php if ($user->gender == 2): ?><i
                                    class="iconfont ico"></i><?php endif; ?></div>
                        <div class="home_list_r_info">
                            <div class="home-basic-option">
                                <input type="text" placeholder="你的身高"
                                       value="<?= isset($user->height) ? $user->height : 155; ?>CM"
                                       readonly="readonly"/>
                                <select id="height" name="height" onchange='tochange(this)'>
                                    <?php for ($i = 155; $i <= 200; $i++): ?>
                                        <option value="<?= $i; ?>" <?= (isset($user->height) && $user->height == $i) ? 'selected' : ''; ?>><?= $i; ?>
                                            CM
                                        </option>
                                    <?php endfor; ?>
                                </select>
                ...
                <?php if ($user->gender == 2): ?>
                    <li class="right-ico">
                        <div class="home_items">
                            <div class="home_list_l_info"><span class="itemsname">三</span><span
                                        class="itemsname">围</span>
                            </div>
                            <div class="home_list_r_info">
                                <input type="hidden" id="bwh_b" name="bwh_b"
                                       value="<?= isset($user->bwh_b) ? $user->bwh_b : 0; ?>"/>
                                <input type="hidden" id="bwh_w" name="bwh_w"
                                       value="<?= isset($user->bwh_w) ? $user->bwh_w : 0; ?>"/>
                                <input type="hidden" id="bwh_h" name="bwh_h"
                                       value="<?= isset($user->bwh_h) ? $user->bwh_h : 0; ?>"/>
                                <input id="bwh" type="text"
                                       placeholder="请选择三围"
                                       readonly="readonly"
                                       value="<?= ($user->bwh_b&&$user->bwh_w&&$user->bwh_h)?($user->bwh_b . ' | ' . $user->bwh_w . ' | ' . $user->bwh_h):''; ?>"/>
                            </div>
                        </div>
                    </li>
                <?php endif; ?>
                <li class="start_sign  right-ico">
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname">星</span><span
                                    class="itemsname">座</span>
                            <?php if ($user->gender == 2): ?><i class="iconfont ico"></i><?php endif; ?>
                        </div>
                        <div class="home_list_r_info">
                            <div class="home-basic-option">
                                <input type="text" placeholder="你的星座" readonly="readonly"
                                       value="<?= isset($user->zodiac) ? Zodiac::getStr($user->zodiac) : '请选择星座'; ?>"/>
                                <select id="zodiac" name="zodiac" onchange='tochange(this)'>
                                    <option value="0" <?= isset($user->zodiac) ? '' : 'selected'; ?>>请选择星座</option>
                                    <option value="1" <?= (isset($user->zodiac) && $user->zodiac == 1) ? 'selected' : ''; ?>>
                                        白羊座
                                    </option>
                                    <option value="2" <?= (isset($user->zodiac) && $user->zodiac == 2) ? 'selected' : ''; ?>>
                                        金牛座
                                    </option>
                                    <option value="3" <?= (isset($user->zodiac) && $user->zodiac == 3) ? 'selected' : ''; ?>>
                                        双子座
                                    </option>
                                    <option value="4" <?= (isset($user->zodiac) && $user->zodiac == 4) ? 'selected' : ''; ?>>
                                        巨蟹座
                                    </option>
                                    <option value="5" <?= (isset($user->zodiac) && $user->zodiac == 5) ? 'selected' : ''; ?>>
                                        狮子座
                                    </option>
                                    <option value="6" <?= (isset($user->zodiac) && $user->zodiac == 6) ? 'selected' : ''; ?>>
                                        处女座
                                    </option>
                                    <option value="7" <?= (isset($user->zodiac) && $user->zodiac == 7) ? 'selected' : ''; ?>>
                                        天秤座
                                    </option>
                                    <option value="8" <?= (isset($user->zodiac) && $user->zodiac == 8) ? 'selected' : ''; ?>>
                                        天蝎座
                                    </option>
                                    <option value="9" <?= (isset($user->zodiac) && $user->zodiac == 9) ? 'selected' : ''; ?>>
                                        射手座
                                    </option>
                                    <option value="10" <?= (isset($user->zodiac) && $user->zodiac == 10) ? 'selected' : ''; ?>>
                                        摩羯座
                                    </option>
                                    <option value="11" <?= (isset($user->zodiac) && $user->zodiac == 11) ? 'selected' : ''; ?>>
                                        水瓶座
                                    </option>
                                    <option value="12" <?= (isset($user->zodiac) && $user->zodiac == 12) ? 'selected' : ''; ?>>
                                        双鱼座
                                    </option>
                                </select>
                            </div>
                ...
                <?php if ($user->gender == 2): ?>
                    <li class="start_sign  right-ico">
                        <div class="home_items">
                            <div class="home_list_l_info required"><span class="itemsname">罩</span><span
                                        class="itemsname">杯</span>
                            ...
                            <div class="home_list_r_info">
                                <div class="home-basic-option">
                                    ...
                                    <select id="cup" name="cup" onchange='tochange(this)'>
                                        ...
                                        <option value="A" <?= (isset($user->cup) && $user->cup == 'A') ? 'selected' : ''; ?>>
                                            A
                                        </option>
                                        <option value="B" <?= (isset($user->cup) && $user->cup == 'B') ? 'selected' : ''; ?>>
                                            B
                                        </option>
                                        <option value="C" <?= (isset($user->cup) && $user->cup == 'C') ? 'selected' : ''; ?>>
                                            C
                                        </option>
                                        <option value="D" <?= (isset($user->cup) && $user->cup == 'D') ? 'selected' : ''; ?>>
                                            D
                                        </option>
                                        <option value="E" <?= (isset($user->cup) && $user->cup == 'E') ? 'selected' : ''; ?>>
                                            E
                                        </option>
                                        <option value="F" <?= (isset($user->cup) && $user->cup == 'F') ? 'selected' : ''; ?>>
                                            F
                                        </option>
                                        <option value="G" <?= (isset($user->cup) && $user->cup == 'G') ? 'selected' : ''; ?>>
                                            G
                                        </option>
                                        <option value="H" <?= (isset($user->cup) && $user->cup == 'H') ? 'selected' : ''; ?>>
                                            H
                                        </option>
                                    </select>
                                </div>
                ...
                <li class="emontion  right-ico">
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname">情</span><span
                                    ...
                                    class="itemsname">态</span><?php if ($user->gender == 2): ?><i
                                    class="iconfont ico"></i><?php endif; ?></div>
                        <div class="home_list_r_info">
                            <div class="home-basic-option">
                                <input type="text" placeholder="你的情感状态" readonly="readonly"
                                       value="<?= (isset($user->state) && $user->state == 1) ? '单身' : '私密'; ?>"/>
                                <select id="state" name="state" onchange='tochange(this)'>
                                    <option value="1" <?= (isset($user->state) && $user->state == 1) ? 'selected' : ''; ?>>
                                        单身
                                    </option>
                                    <option value="2" <?= (isset($user->state) && $user->state == 2) ? 'selected' : ''; ?>>
                                        私密
                                    </option>
                                </select>
                            </div>
                ...
                <li class="right-ico">
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname short_name">家</span><span
                                    class="itemsname">乡</span><?php if ($user->gender == 2): ?><i
                                    class="iconfont ico"></i><?php endif; ?></div>
                        <div class="home_list_r_info">
                ...
                <li class="right-ico">
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname">所</span><span
                                    ...
                                    class="itemsname">区</span><?php if ($user->gender == 2): ?><i
                                    class="iconfont ico"></i><?php endif; ?></div>
                        <div class="home_list_r_info">
                ...
                <li>
                    <div class="home_items">
                        <div class="home_list_l_info required"><span class="itemsname">职</span><span
                                    class="itemsname">业</span>
                            <?php if ($user->gender == 2): ?><i class="iconfont ico"></i><?php endif; ?>
                        </div>
                        <div class="home_list_r_info">
                    ...
                    <div class="home_items">
                       <div class="home_list_l_info"><span class="itemsname">工作经历<br/>/及荣誉
                        ...
                        <div class="home_list_r_info  plaintext">
                            <textarea name="career" class="plaintext-con" style="overflow-y:hidden;"
                                      onpropertychange="this.style.height=this.scrollHeight + 'px'"
                                      oninput="this.style.height=this.scrollHeight + 'px'"
                                      placeholder="请输入工作经历"><?= $user->career; ?></textarea>
                        </div>
                    </div>
                </li>
        </div>
            ...
            <ul>
                <li>
                    <div class="home_items">
                        ...
                        <div class="home_list_r_info" style='width:auto;'>
                            <input id="place" name="place" type="text" placeholder="请输入地点"
                                   value="<?= $user->place; ?>"/>
                        </div>
                    </div>
                </li>
                <li class='plaintext-box'>
                    <div class="home_items">
                        ...
                        <div class="home_list_r_info  plaintext">
                            <textarea id="food" name="food" class="plaintext-con" style="overflow-y:hidden;"
                                      onpropertychange="this.style.height=this.scrollHeight + 'px'"
                                      oninput="this.style.height=this.scrollHeight + 'px'"
                                      placeholder="请输入美食"><?= $user->food; ?></textarea>
                        </div>
                    </div>
                </li>
                <li class='plaintext-box'>
                    <div class="home_items">
                        ...
                        <div class="home_list_r_info  plaintext">
                            <textarea id="music" name="music" class="plaintext-con" style="overflow-y:hidden;"
                                      onpropertychange="this.style.height=this.scrollHeight + 'px'"
                                      oninput="this.style.height=this.scrollHeight + 'px'"
                                      placeholder="请输入音乐"><?= $user->music; ?></textarea>
                        </div>
                    </div>
                </li>
                <li class='plaintext-box'>
                    <div class="home_items">
                        ...
                        <div class="home_list_r_info  plaintext">
                            <textarea id="movie" name="movie" class="plaintext-con" style="overflow-y:hidden;"
                                      onpropertychange="this.style.height=this.scrollHeight + 'px'"
                                      oninput="this.style.height=this.scrollHeight + 'px'"
                                      placeholder="请输入电影"><?= $user->movie; ?></textarea>
                        </div>
                    </div>
                </li>
                <li class='plaintext-box'>
                    <div class="home_items sport_items">
                        ...
                        <div class="home_list_r_info   plaintext">
                            <textarea id="sport" name="sport" class="plaintext-con" style="overflow-y:hidden;"
                                      onpropertychange="this.style.height=this.scrollHeight + 'px'"
                                      oninput="this.style.height=this.scrollHeight + 'px'"
                                      placeholder="请输入运动/娱乐"><?= $user->sport; ?></textarea>
                        </div>
                    </div>
                </li>
                <li class='plaintext-box'>
                    <div class="home_items">
                        ...
                        <div class="home_list_r_info  plaintext">
                            <textarea id="sign" name="sign" class="plaintext-con" style="overflow-y:hidden;"
                                      onpropertychange="this.style.height=this.scrollHeight + 'px'"
                                      oninput="this.style.height=this.scrollHeight + 'px'"
                                      placeholder="请输入个性签名"><?= $user->sign; ?></textarea>
                        </div>
                    </div>
                </li>
            </ul>
