            ...
            <div class="cover_left_info">
                <ul class='opci'>
                    <li class="blight userinfo">
                        ...
                        <h3>
                            <span>
                                <?= $user->nick ?><span class="hot"><img src="/mobile/images/hot.png" class="responseimg"/></span><?php if($user->recharge): ?><span class="diamonds"><img src="/mobile/images/zs.png" class="responseimg"/></span><?php endif; ?><?php if($user->pack): ?><span class="highter-vip">VIP 普通</span><?php endif; ?></span>
