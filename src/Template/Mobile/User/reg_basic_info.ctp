        ...
        <ul>
            <li>
                <div class="home_items">
                    ...
                    <div class="home_list_r_info">
                        <input name="nick" type="text" placeholder="请输入昵称" />
            ...
            <li>
                <div class="home_items">
                    ...
                    <div class="home_list_r_info">
                        <input name="truename" type="text" placeholder="请输真实姓名" />
                        <i class="iconfont r_icon"></i>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="home_items">
                    ...
                    <div class="home_list_r_info">
                        <input name="cup" type="text" placeholder="请输入罩杯" />
                        <i class="iconfont r_icon">&#xe605;</i>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="home_items">
                    ...
                    <div class="home_list_r_info">
                        <input name="hometown" type="text" placeholder="请输入家乡" />
                        <i class="iconfont r_icon">&#xe605;</i>
                    </div>
                </div>
            </li>
            <li>
                <div class="home_items">
                    ...
                    <div class="home_list_r_info">
                        <input name="city" type="text" placeholder="请输入所在地区" />
                        <i class="iconfont r_icon">&#xe605;</i>
                    </div>
                </div>
            </li>
