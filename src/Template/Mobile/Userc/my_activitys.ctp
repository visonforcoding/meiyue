...
<div class="wraper">
    <div class="home_paty_container">
        <div class="date_list_header">
            <div class="date-tab alldate cur" data-query="1" onclick="location.href='#1'"><span class="headertab">进行中</span></div>
            |
            <div class="date-tab todate" data-query="2" onclick="location.href='#2'"><span class="headertab">已结束</span>
            </div>
        </div>
