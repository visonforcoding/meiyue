...
class LogFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'flag' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'msg' => ['type' => 'string', 'length' => 550, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'create_time' => '2016-11-22 16:09:07'
        ],
    ];
}
